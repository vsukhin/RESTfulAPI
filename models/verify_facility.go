...
type ApiVerifyFacility struct {
	...
	DataProducts            []ViewApiDataProduct `json:"estimatedProductIds" db:"-"`                           // Позиции прайс листа
...
type DtoVerifyFacility struct {
	...
	DataProducts            []DtoDataProduct `db:"-"`                       // Позиции прайс листа
...
func NewApiVerifyFacility(estimatedNumbersRecords int, dataProducts []ViewApiDataProduct, tablesDataId int64, tablesDataDelete bool,
	dataColumns []ApiDataColumn, cost float64, costFactual float64, resultTables []ApiResultTable, workTables []ApiWorkTable) *ApiVerifyFacility {
...
func NewDtoVerifyFacility(order_id int64, estimatedNumbersRecords int, dataProducts []DtoDataProduct, tablesDataId int64, tablesDataDelete bool,
