...
func CheckPrimaryUnitUserEmail(emails []models.ViewEmail, language string, r render.Render) (err error) {
	count := 0
...
func CheckPrimaryUnitUserMobilePhone(mobilephones []models.ViewMobilePhone, language string, r render.Render) (err error) {
	count := 0
